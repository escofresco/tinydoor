...
Tinydoor does not reveal the identities of the customers found in the videos it processes, but rather returns a lump sum score for the general sentiment of the group. 
