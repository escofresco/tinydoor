...
MESSAGE_FROM_SQS = (
    '{\n  "Message": "%s",\n  "MessageId": "%s",\n'
    + '  "Signature": "EXAMPLElDMXvB8r9R83tGoNn0ecwd5UjllzsvSvbItzfaMpN2nk5HVSw7XnOn/49IkxDKz8YrlH2qJXj2iZB0Zo'
    + '2O71c4qQk1fMUDi3LGpij7RCW7AW9vYYsSqIKRnFS94ilu7NFhUzLiieYr4BKHpdTmdD6c0esKEYBpabxDSc=",\n'
...
class VideoDetectTestCase(unittest.TestCase):
    ...
    def test_publish_result_to_sqs(self):
        ...
        sqs_conn = boto3.client("sqs", region_name="us-east-1")
        ...
        expected = MESSAGE_FROM_SQS % (message, published_message_id, "us-east-1")
